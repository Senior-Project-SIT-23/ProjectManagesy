...
import DialogFilterActCollegeStudents from "./DialogFilterActCollegeStudents"
...
const headCells = [
  { id: 'activityCollegeStudentName', numeric: false, disablePadding: true, label: 'ชื่อกิจกรรม' },
  { id: 'branch', numeric: true, disablePadding: false, label: 'สาขา' },
  { id: 'year', numeric: true, disablePadding: false, label: 'ปีที่จัดกิจกกรม' },
    ...
    >
      {numSelected > 0 ? (
        ...
        <Typography className={classes.title} variant="h6" id="tableTitle" component="div">
           <div className="font-athiti">กิจกรรมนักศึกษา</div>
        </Typography>
      )}

      {numSelected > 0 ? (

        <DialogDeleteActivityCollegeStudents/>
      ) : (
        <>
        ...
        <Tooltip title="Filter list">
          <DialogFilterActCollegeStudents/>
        </Tooltip>
